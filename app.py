...
# ... Todo tu código actual (parámetros, carga de datos, etc.) ...

# Al final de tu archivo, añade una línea separadora y la sección de aprendizaje
st.markdown("---") 
st.title("📚 Códigos de ejemplo")

# Define los nombres exactos de tus otros archivos .py en tu repositorio
archivos_ejemplo = ["ejemplo1.py", "ejemplo2.py"] 
...
# Bloque para leer y mostrar el archivo elegido
import os
if os.path.exists(archivo_seleccionado):
    ...
    st.info(f"Selecciona un archivo válido para inspeccionar su código.")
